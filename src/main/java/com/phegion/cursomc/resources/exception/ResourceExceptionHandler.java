package com.phegion.cursomc.resources.exception;
...
public class ResourceExceptionHandler {  
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException e, HttpServletRequest request){ //METODO OBRIGATORIO/PADRAO PARA QUE
	                                                                                                           // NAO PRECISA USAR TRY CATCH NO CategoriaResource
